...
<form action="<?=POST_FORM_ACTION_URI?>" method="post">
    ...
    <div class="col-lg-12">
        <div class="product_img_slide owl-carousel owl-theme">
            ...
            <div style="text-align:center;">
                <b style="font-size:30px;"><?=$arQuestion["QUESTION"]?><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></b>
                <br>
	...
	<input style="display: block; margin-left: auto; margin-right: auto;" type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>">&nbsp;&nbsp;
